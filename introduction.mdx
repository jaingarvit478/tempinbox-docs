---
title: Introduction
description: Temp Email is a free temporary email service. Get disposable inboxes instantly — no signup, no expiry timer.
---

## What is Temp Email?

Temp Email ([tempinbox.dev](https://tempinbox.dev)) is a free disposable inbox service. It gives you a working email address in seconds — no account, no password, no expiry timer.
...
Temp Email is also **receive-only** — it accepts inbound SMTP mail but does not support sending outbound email.
