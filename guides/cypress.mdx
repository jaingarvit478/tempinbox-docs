---
title: "Cypress"
description: "Use TempInbox in Cypress tests to automate email verification without mocking."
---
...
- [Playwright guide](/guides/playwright) — the same flow with Playwright fixtures