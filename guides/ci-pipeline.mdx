---
title: CI Pipeline
description: Use Temp Email in GitHub Actions, GitLab CI, and other CI environments for automated email verification testing.
---
...
The Temp Email API requires **no API key** for the public instance. No secrets to manage in CI.
